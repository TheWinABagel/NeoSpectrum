...
public class SpectrumParticleTypes {
	...
	private static <T extends ParticleOptions> ParticleType<T> register(String name, ParticleOptions.Deserializer<T> factory, final Function<ParticleType<T>, Codec<T>> function, boolean alwaysShow) {
		return Registry.register(BuiltInRegistries.PARTICLE_TYPE, SpectrumCommon.locate(name), new ParticleType<T>(alwaysShow, factory) {
			@Override
	...
	@NotNull
	public static ParticleOptions getFluidRisingParticle(DyeColor dyeColor) {
		return switch (dyeColor) {
	...
	@NotNull
	public static ParticleOptions getSparkleRisingParticle(DyeColor dyeColor) {
		return switch (dyeColor) {
	...
	@NotNull
	public static ParticleOptions getExplosionParticle(DyeColor dyeColor) {
		return switch (dyeColor) {
